...
public class DateUtil {
	...
	public static void main(String[] args) throws Exception {
		...
		String s = getNoteStartTime(new Date());
		System.out.println(s);
		System.out.println(convertDateToString("yyyy-MM-dd HH:mm:ss", getAfterWorkDay(s, 2, holiday)));
	}
...
//		}
		...
		if (!"SATURDAY".equals(LocalDate.now().getDayOfWeek().toString()) && !"SUNDAY".equals(LocalDate.now().getDayOfWeek().toString())) {
		...
		LOGGER.info("返回日期：{}（{}）", convertDateToString("yyyy-MM-dd", now.getTime()), convertDateToString("yyyy-MM-dd HH:mm:ss", new Date()));
